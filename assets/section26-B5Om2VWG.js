import"./magnifier-B0Wyiml3.js";import{n as e,r as t,t as n}from"./math-BBrN9Pw_.js";import{a as r,i,o as a,r as o,s}from"./shared-zoT9zLqC.js";var c=document.querySelector(`#app`);c.innerHTML=`
  ${a(`2.6`)}
  <main>
    <section class="lesson-hero lesson-hero--transformations">
      ...
      <div class="transformation-hero-art" aria-hidden="true" data-reveal>
        ...
        <span class="transformation-hero-art__formula">${n(String.raw`g(x)=a f\!\left(b(x-h)\right)+k`)}</span>
      </div>
    </section>
    ...
    <section class="lesson-section" id="transformation-studio">
      <div class="transformation-section-lead">
        <div class="lesson-section__intro" data-reveal>
          ...
          <p>Use <strong>${n(String.raw`g(x)=a f\!\left(b(x-h)\right)+k`)}</strong> as a map. The outside numbers ${n(String.raw`a`)} and ${n(String.raw`k`)} control vertical motion; the inside numbers ${n(String.raw`b`)} and ${n(String.raw`h`)} control horizontal motion.</p>
        </div>
      ...
      <div class="point-witness" data-reveal>
        <div>
          ...
          <p>If <strong>${n(String.raw`(u,f(u))`)}</strong> lies on the original graph, then the transformed point is</p>
          <div class="point-witness__rule">${n(String.raw`(u,f(u))\longmapsto\left(h+\frac{u}{b},\ k+a f(u)\right)`,!0)}</div>
        </div>
    ...
    <section class="lesson-section lesson-section--ink" id="rule-map">
      ...
      <div class="rule-map" data-reveal>
        <div class="rule-map__choices" role="tablist" aria-label="Transformation rules">
          <button type="button" class="is-active" data-rule="up"><span>${n(String.raw`f(x)+c`)}</span><strong>up c</strong></button>
          <button type="button" data-rule="left"><span>${n(String.raw`f(x+c)`)}</span><strong>left c</strong></button>
          <button type="button" data-rule="vscale"><span>${n(String.raw`k f(x)`)}</span><strong>vertical × k</strong></button>
          <button type="button" data-rule="hscale"><span>${n(String.raw`f(kx)`)}</span><strong>horizontal ÷ k</strong></button>
          <button type="button" data-rule="xreflect"><span>${n(String.raw`-f(x)`)}</span><strong>x-axis reflection</strong></button>
          <button type="button" data-rule="yreflect"><span>${n(String.raw`f(-x)`)}</span><strong>y-axis reflection</strong></button>
        </div>
    ...
    <section class="lesson-section" id="formula-lab">
      <div class="lesson-section__intro" data-reveal>
        ...
        <h2>Find the landmark.<br>Then read the shape.</h2>
          <p>The target curve below came from ${n(String.raw`f(x)=x^2`)}. Match its vertex, opening direction, and width to reconstruct ${n(String.raw`g(x)=a(x-h)^2+k`)}.</p>
      </div>
      ...
      <div class="formula-lab" data-reveal>
        ...
        <div class="formula-lab__controls">
          ...
          <div class="formula-clues">
            <article><span>01</span><p>The vertex reveals <strong>${n(String.raw`(h,k)`)}</strong>.</p></article>
            <article><span>02</span><p>Opening down means <strong>${n(String.raw`a<0`)}</strong>.</p></article>
            <article><span>03</span><p>A wider graph has <strong>${n(String.raw`0<|a|<1`)}</strong>.</p></article>
          </div>
    ...
    <section class="lesson-section lesson-section--soft" id="symmetry-lab">
      <div class="lesson-section__intro" data-reveal>
        ...
        <p>An even function satisfies ${n(String.raw`f(-x)=f(x)`)} and has y-axis symmetry. An odd function satisfies ${n(String.raw`f(-x)=-f(x)`)} and has origin symmetry.</p>
      </div>

      <div class="symmetry-test-strip" data-reveal>
        <article><span>Even test</span><strong>${n(String.raw`f(-x)=f(x)`)}</strong><p>${n(String.raw`(x,y)\Longrightarrow(-x,y)`)}</p></article>
        <article><span>Odd test</span><strong>${n(String.raw`f(-x)=-f(x)`)}</strong><p>${n(String.raw`(x,y)\Longrightarrow(-x,-y)`)}</p></article>
      ...
      <div class="symmetry-lab" data-reveal>
        ...
        <div class="symmetry-lab__controls">
          ...
          <div class="symmetry-options" role="tablist" aria-label="Functions to test">
            <button type="button" class="is-active" data-symmetry="quartic"><span>${n(String.raw`x^4-4x^2`)}</span><strong>Even candidate</strong></button>
            <button type="button" data-symmetry="reciprocal"><span>${n(String.raw`x+\frac1x`)}</span><strong>Odd candidate</strong></button>
            <button type="button" data-symmetry="rational"><span>${n(String.raw`\frac{x}{1+x^2}`)}</span><strong>Classify it</strong></button>
            <button type="button" data-symmetry="shifted"><span>${n(String.raw`(x-1)^2`)}</span><strong>Neither candidate</strong></button>
          </div>
    ...
    <section class="lesson-section readiness readiness--transformations" id="readiness">
      ...
      <div class="transformation-check-grid">
        ...
        <article class="transformation-check" data-reveal>
          ...
          <h3>If ${n(String.raw`f(-2)=7`)} and ${n(String.raw`f`)} is odd…</h3>
        ...
        <article class="transformation-check" data-reveal>
          ...
          <h3>Classify ${n(String.raw`f(x)=\frac{x}{1+x^2}`)}.</h3>
...
`,t(c);function l(e,t=2){let n=Number(e.toFixed(t));if(Math.abs(n)<1e-10)return`0`;let r=String(n);return r.startsWith(`-`)?`−${r.slice(1)}`:r}function u(e){return e.replaceAll(`−`,`-`).replaceAll(`²`,`^2`).replaceAll(`⁴`,`^4`).replaceAll(`→`,String.raw`\longrightarrow`).replaceAll(`≠`,String.raw`\ne`).replaceAll(`·`,String.raw`\cdot`)}function d({width:e,height:t,xMin:n,xMax:r,yMin:i,yMax:a,padding:o=46,equalUnits:s=!0}){let c=e-o*2,l=t-o*2,u=c/(r-n),d=l/(a-i),f=o,p=o;if(s){let o=Math.min(u,d);u=o,d=o,f=(e-(r-n)*o)/2,p=(t-(a-i)*o)/2}return{width:e,height:t,xMin:n,xMax:r,yMin:i,yMax:a,left:f,right:f+(r-n)*u,top:p,bottom:p+(a-i)*d,x:e=>f+(e-n)*u,y:e=>p+(a-e)*d}}function f({width:e,height:t,xMin:n,xMax:r,yMin:i,yMax:a,padding:o}){let s=(e-o*2)/(t-o*2),c=r-n,l=a-i;if(c/l<s){let e=l*s,t=(n+r)/2;return{xMin:t-e/2,xMax:t+e/2,yMin:i,yMax:a}}let u=c/s,d=(i+a)/2;return{xMin:n,xMax:r,yMin:d-u/2,yMax:d+u/2}}function p(e,t=`transform`){let n=[];for(let r=Math.ceil(e.xMin);r<=e.xMax;r+=1)n.push(`<line x1="${e.x(r)}" y1="${e.top}" x2="${e.x(r)}" y2="${e.bottom}" class="${t}-grid-line" />`),r!==0&&r%2==0&&n.push(`<text x="${e.x(r)}" y="${e.y(0)+20}" text-anchor="middle" class="${t}-grid-label">${l(r)}</text>`);for(let r=Math.ceil(e.yMin);r<=e.yMax;r+=1)n.push(`<line x1="${e.left}" y1="${e.y(r)}" x2="${e.right}" y2="${e.y(r)}" class="${t}-grid-line" />`),r!==0&&r%2==0&&n.push(`<text x="${e.x(0)+10}" y="${e.y(r)-7}" class="${t}-grid-label">${l(r)}</text>`);return e.yMin<=0&&e.yMax>=0&&n.push(`<line x1="${e.left}" y1="${e.y(0)}" x2="${e.right}" y2="${e.y(0)}" class="${t}-axis" />`),e.xMin<=0&&e.xMax>=0&&n.push(`<line x1="${e.x(0)}" y1="${e.top}" x2="${e.x(0)}" y2="${e.bottom}" class="${t}-axis" />`),n.join(``)}function m(e,t,n=1){let r=``,i=!1;return e.forEach(e=>{if(!e||!Number.isFinite(e[1])||e[1]<t.yMin-n||e[1]>t.yMax+n){i=!1;return}r+=`${i?`L`:`M`}${t.x(e[0]).toFixed(2)} ${t.y(e[1]).toFixed(2)} `,i=!0}),r.trim()}function h(e,t,n,r=.04){let i=[];for(let a=e;a<=t+r/2;a+=r)i.push([a,n(a)]);return i}function g(e){return .075*(e+3)*e*(e-2)}var _=d({width:720,height:630,xMin:-7,xMax:7,yMin:-6,yMax:6,padding:50}),v=document.querySelector(`#transformation-chart`),y=document.querySelector(`#transform-a`),b=document.querySelector(`#transform-b`),x=document.querySelector(`#transform-h`),S=document.querySelector(`#transform-k`),C=document.querySelector(`#witness-u`);function ee(){return{a:Number(y.value),b:Number(b.value),h:Number(x.value),k:Number(S.value)}}function w(e,t){return e===1?t:e===-1?`−${t}`:`${l(e)}${t}`}function T(e,t){let n=t===0?`x`:`x ${t>0?`−`:`+`} ${Math.abs(t)}`;return e===1?n:e===-1?`−(${n})`:`${l(e)}(${n})`}function E({a:e,b:t,h:n,k:r}){return`g(x) = ${w(e,`f(${T(t,n)})`)}${r===0?``:` ${r>0?`+`:`−`} ${Math.abs(r)}`}`}function D(e,t){let n=[];return e===0&&n.push(`collapse every output to one level`),e<0&&n.push(`reflect across the x-axis`),Math.abs(e)>1&&n.push(`stretch by ${l(Math.abs(e))}`),Math.abs(e)<1&&e!==0&&n.push(`compress by ${l(Math.abs(e))}`),t!==0&&n.push(`shift ${t>0?`up`:`down`} ${Math.abs(t)}`),n}function O(e,t){let n=[];return e===0&&n.push(`freeze the function input at 0`),e<0&&n.push(`reflect across the y-axis`),Math.abs(e)>1&&n.push(`compress by 1/${l(Math.abs(e))}`),Math.abs(e)<1&&e!==0&&n.push(`stretch by ${l(1/Math.abs(e))}`),t!==0&&n.push(`shift ${t>0?`right`:`left`} ${Math.abs(t)}`),n}function k(){let t=ee(),n=h(-6,6,g),r=h(-7,7,e=>t.a*g(t.b*(e-t.h))+t.k,.025),i=Number(C.value),a=g(i),o=t.b!==0,s=o?t.h+i/t.b:null,c=t.k+t.a*a;v.innerHTML=`
  ...
  `,e(document.querySelector(`#transformation-formula`),u(E(t))),document.querySelector(`#transform-a-output`).textContent=l(t.a),document.querySelector(`#transform-b-output`).textContent=l(t.b),document.querySelector(`#transform-h-output`).textContent=l(t.h),document.querySelector(`#transform-k-output`).textContent=l(t.k);let d=D(t.a,t.k),f=O(t.b,t.h);document.querySelector(`#vertical-story`).textContent=d.length?d.join(` · `):`No vertical change`,document.querySelector(`#vertical-detail`).textContent=`y becomes ${l(t.a)}y ${t.k>=0?`+`:`−`} ${Math.abs(t.k)}.`,document.querySelector(`#horizontal-story`).textContent=f.length?f.join(` · `):`No horizontal change`,document.querySelector(`#horizontal-detail`).textContent=o?`x becomes h + u/b = ${l(t.h)} + u/${l(t.b)}.`:`With b = 0, every x sends the same input 0 into f.`,document.querySelector(`#witness-u-output`).textContent=l(i);let y=document.querySelector(`#point-witness-result`);o?e(y,String.raw`(${u(l(i))},${u(l(a))})\longmapsto(${u(l(s))},${u(l(c))})`):y.textContent=`b = 0 freezes the input, so this point map is not one-to-one.`}[y,b,x,S,C].forEach(e=>e.addEventListener(`input`,k)),document.querySelector(`#transformation-reset`).addEventListener(`click`,()=>{y.value=`1`,b.value=`1`,x.value=`0`,S.value=`0`,C.value=`1`,k()}),k();var A=d({width:620,height:537,xMin:-7,xMax:7,yMin:-6,yMax:6,padding:21}),j=document.querySelector(`#rule-map-chart`),M=[2,1],N=`up`,P=!1,te={up:{label:`Outside addition`,mapping:`(x, y) → (x, y + c)`,copy:`The input is untouched. Add c directly to every output.`,apply:([e,t])=>[e,t+2]},left:{label:`Inside addition`,mapping:`(x, y) → (x − c, y)`,copy:`Solve x + c = old input. The new x is c units smaller, so the graph moves left.`,apply:([e,t])=>[e-2,t]},vscale:{label:`Outside multiplication`,mapping:`(x, y) → (x, ky)`,copy:`Keep x. Multiply the height by k; negative k also reflects across the x-axis.`,apply:([e,t])=>[e,3*t]},hscale:{label:`Inside multiplication`,mapping:`(x, y) → (x/k, y)`,copy:`Solve kx = old input. Divide x by k; negative k also reflects across the y-axis.`,apply:([e,t])=>[e/2,t]},xreflect:{label:`Negative outside`,mapping:`(x, y) → (x, −y)`,copy:`Every output changes sign, producing a reflection across the x-axis.`,apply:([e,t])=>[e,-t]},yreflect:{label:`Negative inside`,mapping:`(x, y) → (−x, y)`,copy:`Every input changes sign, producing a reflection across the y-axis.`,apply:([e,t])=>[-e,t]}};function F(e,t,n){return Math.min(n,Math.max(t,e))}function I(e,t,n){let r=e=>Math.round(e*10)/10;return[r(F(t,-3,3)),r(F(n,-3,3))]}function L(e){let t=j.createSVGPoint();t.x=e.clientX,t.y=e.clientY;let n=t.matrixTransform(j.getScreenCTM().inverse()),r=A.xMin+(n.x-A.left)/(A.right-A.left)*(A.xMax-A.xMin),i=A.yMax-(n.y-A.top)/(A.bottom-A.top)*(A.yMax-A.yMin);return I(N,r,i)}function R(t){N=t,M=I(t,...M);let n=te[t],[r,i]=M,[a,o]=n.apply(M);j.innerHTML=`
    ${p(A,`rule`)}
  ...
  `,document.querySelector(`#rule-map-label`).textContent=n.label,e(document.querySelector(`#rule-map-mapping`),u(n.mapping)),document.querySelector(`#rule-map-copy`).textContent=n.copy}document.querySelectorAll(`[data-rule]`).forEach(e=>e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-rule]`).forEach(t=>t.classList.toggle(`is-active`,t===e)),R(e.dataset.rule)})),j.addEventListener(`pointerdown`,e=>{e.target.classList.contains(`rule-point--start`)&&(P=!0,j.setPointerCapture(e.pointerId),M=L(e),R(N))}),j.addEventListener(`pointermove`,e=>{P&&(M=L(e),R(N))}),j.addEventListener(`pointerup`,e=>{P=!1,j.hasPointerCapture(e.pointerId)&&j.releasePointerCapture(e.pointerId)}),j.addEventListener(`pointercancel`,()=>{P=!1}),j.addEventListener(`keydown`,e=>{if(!e.target.classList.contains(`rule-point--start`)||!e.key.startsWith(`Arrow`))return;e.preventDefault();let t=e.shiftKey?1:.1,[n,r]={ArrowLeft:[-t,0],ArrowRight:[t,0],ArrowUp:[0,t],ArrowDown:[0,-t]}[e.key];M=I(N,M[0]+n,M[1]+r),R(N),j.querySelector(`.rule-point--start`).focus()}),R(`up`);var z=d({width:680,height:680,xMin:-6,xMax:6,yMin:-6,yMax:6,padding:50}),B=document.querySelector(`#formula-chart`),V=document.querySelector(`#formula-a`),H=document.querySelector(`#formula-h`),U=document.querySelector(`#formula-k`),W={a:-.5,h:2,k:3};function G(){return{a:Number(V.value),h:Number(H.value),k:Number(U.value)}}function K({a:e,h:t,k:n}){let r=t===0?`x`:`x ${t>0?`−`:`+`} ${Math.abs(t)}`;return`g(x) = ${e===1?``:e===-1?`−`:l(e)}(${r})²${n===0?``:` ${n>0?`+`:`−`} ${Math.abs(n)}`}`}function q(){let t=G(),n=h(-6,6,e=>W.a*(e-W.h)**2+W.k,.03),r=h(-6,6,e=>t.a*(e-t.h)**2+t.k,.03);B.innerHTML=`
    ${p(z,`formula`)}
    <path d="${m(n,z)}" class="formula-curve formula-curve--target" />
  ...
  `,e(document.querySelector(`#formula-guess`),u(K(t))),document.querySelector(`#formula-a-output`).textContent=l(t.a),document.querySelector(`#formula-h-output`).textContent=l(t.h),document.querySelector(`#formula-k-output`).textContent=l(t.k);let i=document.querySelector(`#formula-feedback`);i.classList.remove(`is-correct`,`is-incorrect`),i.textContent=``}[V,H,U].forEach(e=>e.addEventListener(`input`,q)),document.querySelector(`#formula-check`).addEventListener(`click`,()=>{let e=G(),t=e.a===W.a&&e.h===W.h&&e.k===W.k;s(document.querySelector(`#formula-feedback`),t,t?`Exactly. The vertex is (2, 3), the graph opens down, and |a| = 1/2 makes it wider.`:`Start with the target vertex. Then use opening direction for the sign of a and width for |a|.`)}),q();var J=document.querySelector(`#symmetry-chart`),Y=document.querySelector(`#symmetry-x`),X=`quartic`,Z=!0,Q={quartic:{formula:`x⁴ − 4x²`,type:`even`,substitution:`f(−x) = (−x)⁴ − 4(−x)²`,simplified:`f(−x) = x⁴ − 4x² = f(x)`,verdict:`Even · reflect the known half across the y-axis.`,fn:e=>e**4-4*e**2,xMax:2.5,yMin:-5,yMax:10,trackerMin:.2,trackerMax:2.3},reciprocal:{formula:`x + 1/x`,type:`odd`,substitution:`f(−x) = −x + 1/(−x)`,simplified:`f(−x) = −x − 1/x = −f(x)`,verdict:`Odd · rotate the known half 180° through the origin.`,fn:e=>e+1/e,xMax:4.5,yMin:-7,yMax:7,trackerMin:.2,trackerMax:4,discontinuous:!0},rational:{formula:`x/(1 + x²)`,type:`odd`,substitution:`f(−x) = (−x)/(1 + (−x)²)`,simplified:`f(−x) = −x/(1 + x²) = −f(x)`,verdict:`Odd · opposite inputs produce opposite outputs.`,fn:e=>e/(1+e**2),xMax:4.5,yMin:-1,yMax:1,trackerMin:.1,trackerMax:4},shifted:{formula:`(x − 1)²`,type:`neither`,substitution:`f(−x) = (−x − 1)² = (x + 1)²`,simplified:`f(−x) ≠ f(x) and f(−x) ≠ −f(x)`,verdict:`Neither · the parabola is symmetric about x = 1, not the y-axis or origin.`,fn:e=>(e-1)**2,xMax:4.5,yMin:-2,yMax:10,trackerMin:.2,trackerMax:2.1}};function $(){let t=Q[X],n=Number(Y.value),r=t.fn(n),i=t.type===`even`?r:t.type===`odd`?-r:t.fn(-n),a={width:680,height:540,padding:52},o=f({...a,xMin:-5,xMax:5,yMin:t.yMin,yMax:t.yMax}),s=d({...a,...o}),c=h(t.discontinuous?.2:0,t.xMax,t.fn,.025),g=h(-t.xMax,t.discontinuous?-.2:0,t.fn,.025),_=X===`shifted`?.2:1,v=r>=s.yMin&&r<=s.yMax,y=i>=s.yMin&&i<=s.yMax;J.innerHTML=`
    ...
    <g>
      ...
      ${v?`<circle cx="${s.x(n)}" cy="${s.y(r)}" r="8" class="symmetry-point symmetry-point--known" />`:``}
      ${Z&&y?`<circle cx="${s.x(-n)}" cy="${s.y(i)}" r="8" class="symmetry-point symmetry-point--mirror" />`:``}
    </g>
  `,e(document.querySelector(`#symmetry-substitution`),u(t.substitution)),e(document.querySelector(`#symmetry-simplified`),u(t.simplified)),document.querySelector(`#symmetry-verdict`).textContent=t.verdict,document.querySelector(`#symmetry-x-output`).textContent=l(n);let b=[];v||b.push(`The tracked point is ${r>s.yMax?`above`:`below`} the visible window.`),y||b.push(`Its partner is ${i>s.yMax?`above`:`below`} the visible window.`),document.querySelector(`#symmetry-point-pair`).innerHTML=`<span>(${l(n)}, ${l(r)}) pairs with (${l(-n)}, ${l(i)})</span>${b.length?`<small>${b.join(` `)}</small>`:``}`;let x=document.querySelector(`#symmetry-reveal`);x.setAttribute(`aria-pressed`,String(Z)),x.textContent=Z?`Hide mirrored half`:`Reveal required half`}document.querySelectorAll(`[data-symmetry]`).forEach(e=>e.addEventListener(`click`,()=>{X=e.dataset.symmetry,Z=!0;let t=Q[X];Y.min=String(t.trackerMin),Y.max=String(t.trackerMax),Number(Y.value)<t.trackerMin&&(Y.value=String(t.trackerMin)),Number(Y.value)>t.trackerMax&&(Y.value=String(t.trackerMax)),document.querySelectorAll(`[data-symmetry]`).forEach(t=>t.classList.toggle(`is-active`,t===e)),$()})),document.querySelector(`#symmetry-reveal`).addEventListener(`click`,()=>{Z=!Z,$()}),Y.addEventListener(`input`,$),$(),document.querySelector(`#check-even`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-even-point`).value===`correct`;s(document.querySelector(`#feedback-even`),e,e?`Correct. Even symmetry changes the sign of x and keeps y.`:`Reflect across the y-axis: negate x, but keep the same output.`)}),document.querySelector(`#check-odd`).addEventListener(`click`,()=>{let e=i(Number(document.querySelector(`#check-odd-value`).value),-7);s(document.querySelector(`#feedback-odd`),e,e?`Correct. Odd symmetry gives f(2) = −f(−2) = −7.`:`For an odd function, opposite inputs have opposite outputs.`)}),document.querySelector(`#check-classification`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-rational`).value===`correct`;s(document.querySelector(`#feedback-classification`),e,e?`Correct. Substitution produces −x/(1 + x²), which is −f(x).`:`Replace x by −x and simplify the squared denominator before comparing.`)}),document.querySelector(`#check-transformation`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-transform`).value===`correct`;s(document.querySelector(`#feedback-transformation`),e,e?`Correct. Right 3 is x − 3 inside; up 2 is +2 outside.`:`Horizontal shifts use the opposite sign inside. Vertical shifts use the stated sign outside.`)}),o();
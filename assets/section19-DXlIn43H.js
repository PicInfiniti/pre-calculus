  ...
  <main>
    <section class="lesson-hero lesson-hero--gold">
      ...
      <div class="coordinate-hero-art" aria-hidden="true" data-reveal>
        ...
        <span class="coordinate-hero__formula coordinate-hero__formula--distance">${n(String.raw`d=\sqrt{(\Delta x)^2+(\Delta y)^2}`)}</span>
        <span class="coordinate-hero__formula coordinate-hero__formula--circle">${n(String.raw`(x-h)^2+(y-k)^2=r^2`)}</span>
      </div>
    </section>
    ...
    <section class="lesson-section" id="coordinate-lab">
      ...
      <div class="formula-ribbon" data-reveal>
        <div><span>Horizontal change</span><strong>${n(String.raw`\Delta x=x_2-x_1`)}</strong></div>
        <div><span>Vertical change</span><strong>${n(String.raw`\Delta y=y_2-y_1`)}</strong></div>
        <div><span>Midpoint</span><strong>${n(String.raw`M=\frac{A+B}{2}`)}</strong></div>
        <div><span>Distance</span><strong>${n(String.raw`d=\sqrt{(\Delta x)^2+(\Delta y)^2}`)}</strong></div>
      </div>
      ...
      <div class="reverse-midpoint" data-reveal>
        <div>
          ...
          <h3>Midpoint ${n(String.raw`M=(-4,-1)`)}. One endpoint is ${n(String.raw`A=(-2,1)`)}. Where is ${n(String.raw`B`)}?</h3>
          <p>If ${n(String.raw`M_x=\frac{A_x+B_x}{2}`)}, then ${n(String.raw`B_x=2M_x-A_x`)}. Use the same move for ${n(String.raw`y`)}.</p>
        </div>
      ...
      <div class="median-workbench" data-reveal>
        ...
        <div class="median-solution">
          ...
          <ol>
            ...
            <li><span>3</span><div><strong>Simplify the radical.</strong><p>${n(String.raw`\sqrt{80}=\sqrt{16\cdot5}=4\sqrt5`)}.</p></div></li>
          </ol>
    ...
    <section class="lesson-section" id="diameter-lab">
      <div class="lesson-section__intro" data-reveal>
        ...
        <p>The center is the midpoint of the diameter. The radius is half its length—or use one endpoint to find ${n(String.raw`r^2`)} directly.</p>
      </div>
    ...
    <section class="lesson-section lesson-section--ink" id="complete-square">
      ...
      <div class="square-studio" data-reveal>
        <div class="square-studio__steps">
          ...
          <h3>${n(String.raw`x^2+y^2-10x+12y+54=0`)}</h3>
          <ol>
            <li class="is-visible"><span>1</span><p>${n(String.raw`(x^2-10x)+(y^2+12y)=-54`)}</p></li>
            <li><span>2</span><p>Add 25 and 36 to both sides.</p></li>
            <li><span>3</span><p>${n(String.raw`(x-5)^2+(y+6)^2=7`)}</p></li>
          </ol>
        ...
        <div class="square-studio__answer">
          ...
          <div class="completion-rule">
            ...
            <p>${n(String.raw`x^2+bx`)} becomes ${n(String.raw`(x+\frac b2)^2`)} after adding ${n(String.raw`(\frac b2)^2`)}.</p>
          </div>
        </div>
      </div>

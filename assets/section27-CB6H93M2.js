import"./magnifier-B0Wyiml3.js";import{n as e,r as t,t as n}from"./math-BBrN9Pw_.js";import{a as r,i,o as a,r as o,s}from"./shared-DVcn0svv.js";var c=document.querySelector(`#app`);function l(e,n,r){s(e,n,``),e.innerHTML=r,t(e)}c.innerHTML=`
  ${a(`2.7`)}
  <main>
    <section class="lesson-hero lesson-hero--combinations">
      ...
      <div class="combination-hero-art" aria-hidden="true" data-reveal>
        ...
        <div class="hero-machine hero-machine--f"><span>outer</span><strong>f</strong><small>receives ${n(String.raw`g(x)`)}</small></div>
        <div class="hero-machine__path hero-machine__path--one"><i>${n(String.raw`x`)}</i></div>
        <div class="hero-machine__path hero-machine__path--two"><i>${n(String.raw`g(x)`)}</i></div>
        <div class="hero-machine__path hero-machine__path--three"><i>${n(String.raw`f(g(x))`)}</i></div>
        <div class="hero-operation-card">${n(String.raw`(f+g)(x)`)}</div>
        <div class="hero-composition-card">${n(String.raw`f\circ g`)} <span class="hero-composition-card__direction">right to left</span></div>
      </div>
    </section>
    ...
    <section class="lesson-section" id="domain-gates">
      <div class="combination-section-lead">
        ...
        <div class="domain-rule-stack" data-reveal>
          <article><span>Side by side</span><strong>${n(String.raw`D_{f\pm g}=D_f\cap D_g`)}</strong></article>
          <article><span>Quotient</span><strong>${n(String.raw`D_{f/g}=D_f\cap D_g,\quad g(x)\ne 0`)}</strong></article>
          <article><span>Composition</span><strong>${n(String.raw`x\in D_g\quad\text{and}\quad g(x)\in D_f`)}</strong></article>
        </div>
      </div>
      ...
      <div class="domain-gate-lab" data-reveal>
        <div class="domain-gate-lab__stage">
          <div class="domain-function-pair" aria-label="Functions used in the domain explorer">
            <span><i>f</i><b>${n(String.raw`f(x)=\sqrt{x+2}`)}<small>${n(String.raw`D_f=[-2,\infty)`)}</small></b></span>
            <span><i>g</i><b>${n(String.raw`g(x)=\sqrt{1-x}`)}<small>${n(String.raw`D_g=(-\infty,1]`)}</small></b></span>
          </div>
        ...
        <div class="domain-gate-lab__controls">
          ...
          <div class="domain-operation-tabs" role="tablist" aria-label="Function combinations">
            <button class="is-active" type="button" data-domain-operation="sum" role="tab" aria-selected="true">${n(String.raw`f+g`)}</button>
            <button type="button" data-domain-operation="quotient" role="tab" aria-selected="false">${n(String.raw`f/g`)}</button>
            <button type="button" data-domain-operation="composition" role="tab" aria-selected="false">${n(String.raw`g\circ f`)}</button>
          </div>
    ...
    <section class="lesson-section lesson-section--ink" id="composition-order">
      <div class="lesson-section__intro" data-reveal>
        ...
        <p>In ${n(String.raw`(f\circ g)(x)=f(g(x))`)}, ${n(String.raw`g`)} acts first. Its output becomes the input of ${n(String.raw`f`)}. Reversing the order can produce a different function and a different answer.</p>
      </div>
      ...
      <div class="order-lab" data-reveal>
        <div class="order-lab__controls">
          ...
          <div class="order-function-definitions">
            <article><span>f</span><div><strong>10% discount</strong><small>${n(String.raw`f(x)=0.90x`)}</small></div></article>
            <article><span>g</span><div><strong>$100 rebate</strong><small>${n(String.raw`g(x)=x-100`)}</small></div></article>
          </div>
          ...
          <div class="order-choice" role="tablist" aria-label="Composition order">
            <button class="is-active" type="button" data-order="fg" role="tab" aria-selected="true"><span>${n(String.raw`f\circ g`)}</span>rebate, then discount</button>
            <button type="button" data-order="gf" role="tab" aria-selected="false"><span>${n(String.raw`g\circ f`)}</span>discount, then rebate</button>
          </div>
        </div>
        <div class="order-machine" aria-live="polite">
          ...
          <div class="order-comparison">
            <div><span>${n(String.raw`f\circ g`)}</span><b id="order-fg-total">$630</b><i id="order-fg-bar"></i></div>
            <div><span>${n(String.raw`g\circ f`)}</span><b id="order-gf-total">$620</b><i id="order-gf-bar"></i></div>
          </div>
    ...
    <section class="lesson-section lesson-section--soft" id="decomposition-lab">
      ...
      <div class="peel-lab" data-reveal>
        <div class="peel-lab__menu" role="tablist" aria-label="Expressions to decompose">
          <button class="is-active" type="button" data-peel="power" role="tab" aria-selected="true"><span>A</span><b>${n(String.raw`(5-\sqrt[3]{x})^7`)}</b></button>
          <button type="button" data-peel="rational" role="tab" aria-selected="false"><span>B</span><b>${n(String.raw`\frac{t^2}{t^2+4}`)}</b></button>
          <button type="button" data-peel="radical" role="tab" aria-selected="false"><span>C</span><b>${n(String.raw`\sqrt{s^3+4s}`)}</b></button>
          <button type="button" data-peel="triple" role="tab" aria-selected="false"><span>D</span><b>${n(String.raw`3-\sqrt[4]{5x}`)}</b></button>
        </div>
      ...
      <aside class="composition-reading" data-reveal>
        ...
        <p><strong>${n(String.raw`f\circ g\circ h`)}</strong> means “h first, then g, then f.” Evaluation always begins beside the input.</p>
      </aside>
    </section>
    ...
    <section class="lesson-section" id="model-chain">
      ...
      <div class="balloon-lab" data-reveal>
        ...
        <div class="balloon-controls">
          ...
          <div class="model-pipeline">
            <article><span>time → radius</span><strong>${n(String.raw`r=f(t)=5t`)}</strong><small id="balloon-radius-readout"></small></article>
            <i>→</i>
            <article><span>radius → volume</span><strong>${n(String.raw`V=g(r)=\frac{4}{3}\pi r^3`)}</strong><small id="balloon-volume-readout"></small></article>
          </div>
          <div class="model-composite">
            <span>Direct time-to-volume model</span>
            <strong>${n(String.raw`(g\circ f)(t)=\frac{4}{3}\pi(5t)^3=\frac{500}{3}\pi t^3`,!0)}</strong>
      ...
      <div class="domain-blueprint" data-reveal>
        ...
        <div class="domain-blueprint__answer" id="blueprint-answer" hidden>
          <span>Inner</span><strong>${n(String.raw`g(x)=x^2`)}</strong>
          <i>→</i>
          <span>Outer</span><strong>${n(String.raw`f(u)=\sqrt{\frac{4-u}{u}}`)}</strong>
          <p>The outer domain is ${n(String.raw`(0,4]`)}. Requiring ${n(String.raw`x^2\in(0,4]`)} gives ${n(String.raw`0<x^2\le 4`)}, so ${n(String.raw`-2\le x<0`)} or ${n(String.raw`0<x\le 2`)}.</p>
        </div>
      </div>
    </section>
    ...
    <section class="lesson-section readiness readiness--combinations" id="readiness">
      ...
      <div class="combination-check-grid">
        <article class="combination-check" data-reveal>
          ...
          <h3>Find the domain of ${n(String.raw`\frac{\sqrt{x-3}}{x-5}`)}.</h3>
        ...
        <article class="combination-check" data-reveal>
          ...
          <h3>If ${n(String.raw`f(x)=2x+1`)} and ${n(String.raw`g(x)=x^2`)}, find ${n(String.raw`(f\circ g)(3)`)}.</h3>
        ...
        <article class="combination-check" data-reveal>
          <span>Decompose</span>
          <h3>Write ${n(String.raw`\sqrt{x^3+4x}`)} as ${n(String.raw`f\circ g`)}.</h3>
...
`,t(c);function u(e,t=2){if(!Number.isFinite(e))return`undefined`;let n=Number(e.toFixed(t));return String(n).replace(`-`,`−`)}function d(e){return new Intl.NumberFormat(`en-US`,{style:`currency`,currency:`USD`,maximumFractionDigits:0}).format(e)}function f(e){return new Intl.NumberFormat(`en-US`,{maximumFractionDigits:1}).format(e)}function p(e,t=2){let n=Number(e.toFixed(t));return String(n)}var m={sum:{domain:`[−2, 1]`,formulaTex:String.raw`(f+g)(x)=\sqrt{x+2}+\sqrt{1-x}`,domainTex:String.raw`[-2,1]`,reason:`Both radicals must be real.`,interval:[-2,1],closed:[!0,!0],gates(e){let t=e>=-2,r=e<=1;return[{pass:t,titleMarkup:`${n(String.raw`f(x)`)} is ${t?`real`:`not real`}`,detailTex:String.raw`x+2${t?String.raw`\ge`:`<`}0`},{pass:r,titleMarkup:`${n(String.raw`g(x)`)} is ${r?`real`:`not real`}`,detailTex:String.raw`1-x${r?String.raw`\ge`:`<`}0`},{pass:t&&r,title:t&&r?`Input accepted`:`Input blocked`,detailTex:t&&r?String.raw`\text{Value}\approx ${p(Math.sqrt(e+2)+Math.sqrt(1-e))}`:null,detail:`Both gates must pass`}]}},quotient:{domain:`[−2, 1)`,formulaTex:String.raw`\left(\frac{f}{g}\right)(x)=\frac{\sqrt{x+2}}{\sqrt{1-x}}`,domainTex:String.raw`[-2,1)`,reason:`Both radicals must be real, and ${n(String.raw`g(x)\ne0`)}.`,interval:[-2,1],closed:[!0,!1],gates(e){let t=e>=-2&&e<=1,n=e<1;return[{pass:t,title:t?`Radicals are real`:`A radical fails`,detailTex:String.raw`-2\le x\le 1`},{pass:n,title:n?`Denominator is nonzero`:`Division by zero`,detailTex:String.raw`g(x)${n?String.raw`\ne`:`=`}0`},{pass:t&&n,title:t&&n?`Input accepted`:`Input blocked`,detailTex:t&&n?String.raw`\text{Value}\approx ${p(Math.sqrt(e+2)/Math.sqrt(1-e))}`:null,detail:`Every restriction must pass`}]}},composition:{domain:`[−2, −1]`,formulaTex:String.raw`(g\circ f)(x)=\sqrt{1-\sqrt{x+2}}`,domainTex:String.raw`[-2,-1]`,reason:`The inner radical must be real and its output must satisfy ${n(String.raw`f(x)\le1`)}.`,interval:[-2,-1],closed:[!0,!0],gates(e){let t=e>=-2,n=t?Math.sqrt(e+2):NaN,r=t&&n<=1;return[{pass:t,title:t?`Inner f works`:`Inner f is blocked`,detailTex:t?String.raw`f(x)\approx ${p(n)}`:String.raw`x+2<0`},{pass:r,title:r?`Output fits g`:`Output does not fit g`,detailTex:t?String.raw`f(x)${r?String.raw`\le`:`>`}1`:null,detail:`No inner output to test`},{pass:t&&r,title:t&&r?`Input accepted`:`Input blocked`,detailTex:t&&r?String.raw`\text{Value}\approx ${p(Math.sqrt(1-n))}`:null,detail:`The output handoff fails`}]}}},h=`sum`,g=document.querySelector(`#domain-x`);function _(e,t){let n=document.querySelector(`#domain-number-line`),r=e=>64+(e- -4)/7*632,[i,a]=e.interval,o=e.gates(t)[2].pass,s=[];for(let e=-4;e<=3;e+=1)s.push(`
  ...
  `}function v(){let n=m[h],r=Number(g.value),i=n.gates(r);e(document.querySelector(`#domain-formula`),n.formulaTex,!0),e(document.querySelector(`#domain-answer`),n.domainTex);let a=document.querySelector(`#domain-reason`);a.innerHTML=n.reason,t(a),document.querySelector(`#domain-x-output`).textContent=u(r,1),[`one`,`two`,`three`].forEach((n,r)=>{let a=document.querySelector(`#domain-gate-${n}`);a.classList.toggle(`is-pass`,i[r].pass),a.classList.toggle(`is-blocked`,!i[r].pass);let o=a.querySelector(`strong`);i[r].titleMarkup?(o.innerHTML=i[r].titleMarkup,t(o)):o.textContent=i[r].title;let s=a.querySelector(`small`);i[r].detailTex?e(s,i[r].detailTex):s.textContent=i[r].detail});let o=i[2].pass,s=document.querySelector(`#domain-verdict`);s.className=`domain-verdict ${o?`is-pass`:`is-blocked`}`,s.innerHTML=`<strong>${o?`${u(r,1)} is in the domain.`:`${u(r,1)} is not in the domain.`}</strong><span>${o?`Every required gate is open.`:`At least one required gate is closed.`}</span>`,_(n,r)}document.querySelectorAll(`[data-domain-operation]`).forEach(e=>{e.addEventListener(`click`,()=>{h=e.dataset.domainOperation,document.querySelectorAll(`[data-domain-operation]`).forEach(t=>{let n=t===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-selected`,String(n))}),v()})}),g.addEventListener(`input`,v),v();var y=`fg`,b=document.querySelector(`#order-price`);function x(){let t=Number(b.value),n=t-100,r=n*.9,i=t*.9,a=i-100,o=y===`fg`;document.querySelector(`#order-price-output`).textContent=d(t),e(document.querySelector(`#order-formula`),o?String.raw`(f\circ g)(x)=0.90(x-100)`:String.raw`(g\circ f)(x)=0.90x-100`,!0),document.querySelector(`#order-step-input`).textContent=d(t),document.querySelector(`#order-inner-label`).textContent=o?`g acts first`:`f acts first`,document.querySelector(`#order-step-middle`).textContent=d(o?n:i),document.querySelector(`#order-outer-label`).textContent=o?`f acts second`:`g acts second`,document.querySelector(`#order-step-final`).textContent=d(o?r:a),document.querySelector(`#order-fg-total`).textContent=d(r),document.querySelector(`#order-gf-total`).textContent=d(a),document.querySelector(`#order-fg-bar`).style.width=`${Math.max(8,r/t*100)}%`,document.querySelector(`#order-gf-bar`).style.width=`${Math.max(8,a/t*100)}%`,document.querySelector(`#order-insight`).textContent=`Discounting first and subtracting the rebate second saves ${d(r-a)} more. The rebate stays a full $100.`}document.querySelectorAll(`[data-order]`).forEach(e=>{e.addEventListener(`click`,()=>{y=e.dataset.order,document.querySelectorAll(`[data-order]`).forEach(t=>{let n=t===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-selected`,String(n))}),x()})}),b.addEventListener(`input`,x),x();var S={power:{targetTex:String.raw`F(x)=(5-\sqrt[3]{x})^7`,prompt:`The seventh power happens last, so keep the entire “5 minus” expression in the outer function.`,layers:[{label:`input`,formulaTex:String.raw`x`},{label:`inner g`,formulaTex:String.raw`g(x)=\sqrt[3]{x}`},{label:`outer f`,formulaTex:String.raw`f(u)=(5-u)^7`}],resultTex:String.raw`F=f\circ g,\qquad \text{because}\qquad f(g(x))=(5-\sqrt[3]{x})^7`},rational:{targetTex:String.raw`G(t)=\frac{t^2}{t^2+4}`,prompt:`The same ${n(String.raw`t^2`)} appears twice. Treat that repeated expression as one inner output.`,layers:[{label:`input`,formulaTex:String.raw`t`},{label:`inner g`,formulaTex:String.raw`g(t)=t^2`},{label:`outer f`,formulaTex:String.raw`f(u)=\frac{u}{u+4}`}],resultTex:String.raw`G=f\circ g,\qquad \text{because}\qquad f(g(t))=\frac{t^2}{t^2+4}`},radical:{targetTex:String.raw`H(s)=\sqrt{s^3+4s}`,prompt:`The square root happens last. Everything beneath it belongs to the inner function.`,layers:[{label:`input`,formulaTex:String.raw`s`},{label:`inner g`,formulaTex:String.raw`g(s)=s^3+4s`},{label:`outer f`,formulaTex:String.raw`f(u)=\sqrt{u}`}],resultTex:String.raw`H=f\circ g,\qquad \text{because}\qquad f(g(s))=\sqrt{s^3+4s}`},triple:{targetTex:String.raw`G(x)=3-\sqrt[4]{5x}`,prompt:`Follow the construction: multiply by 5, take a fourth root, then subtract from 3.`,layers:[{label:`input`,formulaTex:String.raw`x`},{label:`inner h`,formulaTex:String.raw`h(x)=5x`},{label:`middle g`,formulaTex:String.raw`g(u)=\sqrt[4]{u}`},{label:`outer f`,formulaTex:String.raw`f(v)=3-v`}],resultTex:String.raw`G=f\circ g\circ h,\qquad \text{read from right to left}`}},C=`power`,w=1;function T(){let r=S[C];e(document.querySelector(`#peel-target`),r.targetTex);let i=document.querySelector(`#peel-prompt`);i.innerHTML=r.prompt,t(i);let a=document.querySelector(`#peel-pipeline`);a.innerHTML=r.layers.map((e,t)=>`
      ${t?`<i class="peel-arrow ${t<w?`is-visible`:``}" aria-hidden="true">→</i>`:``}
      <article class="peel-layer ${t<w?`is-visible`:``}">
        <span>${t<w?e.label:`hidden layer`}</span>
        <strong>${t<w?n(e.formulaTex):`?`}</strong>
      </article>
    `).join(``),t(a);let o=w>=r.layers.length,s=document.querySelector(`#peel-next`);s.disabled=o,s.textContent=o?`All layers revealed`:`Peel the next layer`;let c=document.querySelector(`#peel-equivalence`);o?e(c,r.resultTex):c.textContent=``}document.querySelectorAll(`[data-peel]`).forEach(e=>{e.addEventListener(`click`,()=>{C=e.dataset.peel,w=1,document.querySelectorAll(`[data-peel]`).forEach(t=>{let n=t===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-selected`,String(n))}),T()})}),document.querySelector(`#peel-next`).addEventListener(`click`,()=>{w=Math.min(S[C].layers.length,w+1),T()}),document.querySelector(`#peel-reset`).addEventListener(`click`,()=>{w=1,T()}),T();var E=document.querySelector(`#balloon-time`);function D(){let t=Number(E.value),n=t>=12,r=document.querySelector(`.balloon-lab`),i=t/12,a=Math.round(46+i*50),o=Math.round(92-i*6),s=Math.round(78-i*14),c=Math.round(68-i*20),l=3.4-i*2.55;r.style.setProperty(`--balloon-saturation`,`${a}%`),r.style.setProperty(`--balloon-light`,`${o}%`),r.style.setProperty(`--balloon-middle`,`${s}%`),r.style.setProperty(`--balloon-deep`,`${c}%`),r.style.setProperty(`--balloon-pulse-duration`,`${l.toFixed(2)}s`),E.style.accentColor=`hsl(11, ${a}%, ${c}%)`;let d=t*5,p=4*d**3/3,m=34+t/12*154;document.querySelector(`#balloon-circle`).setAttribute(`r`,m);let h=document.querySelector(`#balloon-highlight`);h.setAttribute(`cx`,310-m*.32),h.setAttribute(`cy`,246-m*.34),h.setAttribute(`rx`,Math.max(7,m*.12)),h.setAttribute(`ry`,Math.max(12,m*.2));let g=246+m;document.querySelector(`#balloon-knot`).setAttribute(`d`,`M298 ${g-2}L322 ${g-2}L310 ${g+19}Z`),document.querySelector(`#balloon-string`).setAttribute(`d`,`M310 ${g+18}C292 ${g+58} 335 ${g+84} 310 505`),document.querySelector(`#balloon-radius-line`).setAttribute(`x2`,310+m);let _=document.querySelector(`#balloon-radius-label`);_.setAttribute(`x`,310+m/2),_.textContent=`r = ${u(d,1)} cm`,document.querySelector(`#balloon-time-output`).textContent=`${u(t,1)} s`,document.querySelector(`.balloon-stage`).classList.toggle(`is-popped`,n),document.querySelector(`#balloon-svg`).setAttribute(`aria-label`,n?`A balloon popping after reaching the maximum inflation time`:`A balloon growing as time increases`);let v=document.querySelector(`#balloon-pressure`),y=n?`popped`:t>=10?`danger`:t>=7?`caution`:`safe`,b={safe:`Stable`,caution:`Pressure rising`,danger:`Near its limit`,popped:`Surprise!`}[y];v.className=`balloon-pressure is-${y}`,v.querySelector(`strong`).textContent=b,e(document.querySelector(`#balloon-radius-readout`),String.raw`r=${u(d,1)}\,\mathrm{cm}`),e(document.querySelector(`#balloon-volume-readout`),String.raw`V=${f(p).replaceAll(`,`,`{,}`)}\pi\,\mathrm{cm}^3`),document.querySelector(`#balloon-meaning`).textContent=n?`At 12 seconds, the model reaches the demo’s inflation limit—the calculated radius is 60 cm, and the balloon pops.`:`At ${u(t,1)} seconds, the composite returns the balloon’s volume directly from time.`}E.addEventListener(`input`,D),D(),document.querySelector(`#blueprint-reveal`).addEventListener(`click`,e=>{let t=document.querySelector(`#blueprint-answer`),n=t.hidden;t.hidden=!n,e.currentTarget.setAttribute(`aria-expanded`,String(n)),e.currentTarget.textContent=n?`Hide construction`:`Reveal one construction`}),document.querySelector(`#check-domain-button`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-domain`).value===`correct`;l(document.querySelector(`#feedback-domain`),e,e?`Correct. ${n(String.raw`x=3`)} is allowed by the radical, but ${n(String.raw`x=5`)} makes the denominator zero.`:`Require ${n(String.raw`x-3\ge 0`)}, then remove the value that makes ${n(String.raw`x-5`)} equal zero.`)}),document.querySelector(`#check-composite-button`).addEventListener(`click`,()=>{let e=i(Number(document.querySelector(`#check-composite`).value),19);l(document.querySelector(`#feedback-composite`),e,e?`Correct. ${n(String.raw`g(3)=9`)} first, and ${n(String.raw`f(9)=2(9)+1=19`)}.`:`Start with the inner function: find ${n(String.raw`g(3)`)}, then use that result as ${n(String.raw`f`)}’s input.`)}),document.querySelector(`#check-decompose-button`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-decompose`).value===`correct`;l(document.querySelector(`#feedback-decompose`),e,e?`Correct. Build ${n(String.raw`x^3+4x`)} first, then take the square root of that entire output.`:`Ask which operation happens last. The square root is the outer function.`)}),document.querySelector(`#check-order-button`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-order`).value===`correct`;l(document.querySelector(`#feedback-order`),e,e?`Correct. ${n(String.raw`0.90(800)-100=\$620`)}, which is $10 less than ${n(String.raw`0.90(800-100)=\$630`)}.`:`Compare ${n(String.raw`0.90(800-100)`)} with ${n(String.raw`0.90(800)-100`)}. The order changes whether the rebate is discounted too.`)}),o();
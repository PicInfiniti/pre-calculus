  ...
  <main>
    <section class="lesson-hero lesson-hero--inverses">
      ...
      <div class="inverse-hero-art" aria-hidden="true" data-reveal>
        ...
        <span class="inverse-hero-art__tag inverse-hero-art__tag--forward">${n(String.raw`(a,b)`)}</span>
        <span class="inverse-hero-art__tag inverse-hero-art__tag--inverse">${n(String.raw`(b,a)`)}</span>
        <span class="inverse-hero-art__tag inverse-hero-art__tag--mirror">${n(String.raw`y=x`)}</span>
        <div class="inverse-hero-art__identity">${n(String.raw`f^{-1}(f(x))=x`)}</div>
      </div>
    </section>
    ...
    <section class="lesson-section lesson-section--ink" id="horizontal-test">
      ...
      <div class="horizontal-lab" data-reveal>
        ...
        <div class="horizontal-lab__controls">
          ...
          <label for="horizontal-y"><span>Move the line to ${n(String.raw`y=`)}</span><output id="horizontal-y-output">0</output></label>
    ...
    <section class="lesson-section lesson-section--soft" id="inverse-graphs">
      <div class="lesson-section__intro" data-reveal>
        ...
        <h2>The inverse is a reflection<br>across ${n(String.raw`y=x`)}.</h2>
        <p>Switching input and output turns every point ${n(String.raw`(a,b)`)} into ${n(String.raw`(b,a)`)}, so domain and range trade places.</p>
      </div>
      ...
      <div class="reflection-lab" data-reveal>
        ...
        <div class="reflection-lab__controls">
          ...
          <div class="reflection-legend">
            <span><i></i>${n(String.raw`f`)}</span>
            <span><i></i>${n(String.raw`f^{-1}`)}</span>
            <span><i></i>${n(String.raw`y=x`)}</span>
          </div>
          ...
          <div class="coordinate-swap">
            <article><span>Point on ${n(String.raw`f`)}</span><strong id="reflection-forward-point"></strong></article>
            <i aria-hidden="true">⇄</i>
            <article><span>Point on ${n(String.raw`f^{-1}`)}</span><strong id="reflection-inverse-point"></strong></article>
          </div>
          <dl class="inverse-domain-swap">
            <div><dt>${n(String.raw`D_f`)}</dt><dd>${n(String.raw`[-3,4]`)}</dd></div>
            <div><dt>${n(String.raw`R_f`)}</dt><dd>${n(String.raw`[-2,2]`)}</dd></div>
            <div><dt>${n(String.raw`D_{f^{-1}}`)}</dt><dd>${n(String.raw`[-2,2]`)}</dd></div>
            <div><dt>${n(String.raw`R_{f^{-1}}`)}</dt><dd>${n(String.raw`[-3,4]`)}</dd></div>
          </dl>
        </div>
      </div>
    </section>
    ...
    <section class="lesson-section" id="inverse-values">
      <div class="lesson-section__intro" data-reveal>
        ...
        <p>You do not always need an inverse formula. If you know ${n(String.raw`f(a)=b`)}, then you immediately know ${n(String.raw`f^{-1}(b)=a`)}.</p>
      </div>

      <div class="undo-lab" data-reveal>
        <div class="undo-lab__machine">
          <div class="undo-formula">${n(String.raw`f(x)=x^5+x^3+x`)}</div>
          <div class="undo-track">
            <article><span>input</span><strong id="undo-input-value">1</strong></article>
            <i>→</i>
            <article class="undo-track__function"><span>${n(String.raw`f`)}</span><strong>forward</strong></article>
            <i>→</i>
          ...
          <div class="undo-track undo-track--reverse">
            ...
            <i>→</i>
            <article class="undo-track__inverse"><span>${n(String.raw`f^{-1}`)}</span><strong>undo</strong></article>
            <i>→</i>
        ...
        <div class="undo-lab__controls">
          ...
          <label for="undo-x">Try ${n(String.raw`x=`)} <output id="undo-x-output">1</output></label>
          <input id="undo-x" type="range" min="-1.5" max="1.5" step="0.1" value="1" />
          <div class="undo-target"><span>Target output</span><strong>${n(String.raw`3`)}</strong><i id="undo-target-meter"></i></div>
          <div class="undo-verdict" id="undo-verdict" aria-live="polite"></div>
          <div class="inverse-identities">
            <span>${n(String.raw`f^{-1}(f(x))=x`)}</span>
            <span>${n(String.raw`f(f^{-1}(x))=x`)}</span>
          </div>
          <p class="inverse-warning"><strong>${n(String.raw`f^{-1}`)} is inverse notation.</strong> It does not mean ${n(String.raw`\frac1f`)}.</p>
        </div>
      </div>
    </section>
    ...
    <section class="lesson-section lesson-section--ink" id="inverse-algebra">
      <div class="lesson-section__intro" data-reveal>
        ...
        <p>Write the rule with ${n(String.raw`y`)}, exchange ${n(String.raw`x`)} and ${n(String.raw`y`)}, and solve for the new output. The domain of the inverse is the original range.</p>
      </div>
    ...
    <section class="lesson-section readiness readiness--inverses" id="readiness">
      ...
      <div class="inverse-check-grid">
        <article class="inverse-check" data-reveal>
          ...
          <label><span>${n(String.raw`r(t)=t^4-1`)} on all reals</span>
          ...
          <label><span>${n(String.raw`f(x)=x^4+5,\ 0\le x\le2`)}</span>
        ...
        <article class="inverse-check" data-reveal>
          ...
          <h3>Suppose ${n(String.raw`f(4)=17`)}.</h3>
          <label>${n(String.raw`f^{-1}(17)=`)} <input id="check-inverse-value" type="number" /></label>
          <label>${n(String.raw`f(f^{-1}(4x+3))=`)}
        ...
        <article class="inverse-check" data-reveal>
          ...
          <h3>If ${n(String.raw`(2,-3)`)} lies on ${n(String.raw`f`)}, what lies on ${n(String.raw`f^{-1}`)}?</h3>
        ...
        <article class="inverse-check" data-reveal>
          ...
          <h3>Choose the inverse of ${n(String.raw`f(x)=3x-5`)}.</h3>
          <label>Inverse rule
...
`,t(c);var u=document.querySelector(`.inverse-hero-art__curve--forward`),d=document.querySelector(`.inverse-hero-art__point--forward`),f=document.querySelector(`.inverse-hero-art__point--inverse`),p=window.matchMedia(`(prefers-reduced-motion: reduce)`),m=u.getTotalLength(),h=0,g=0;function _(e){let t=u.getPointAtLength(m*e);d.setAttribute(`cx`,t.x),d.setAttribute(`cy`,t.y),f.setAttribute(`cx`,500-t.y),f.setAttribute(`cy`,500-t.x)}function v(e){let t=e-g;_(.5+.45*Math.sin(t/12e3*Math.PI*2)),h=window.requestAnimationFrame(v)}function y(){window.cancelAnimationFrame(h),_(.5),!p.matches&&(g=performance.now(),h=window.requestAnimationFrame(v))}p.addEventListener(`change`,y),y();function b(e,t=2){if(!Number.isFinite(e))return`—`;let n=Number(e.toFixed(t));return String(n).replace(`-`,`−`)}var x={injective:{name:`A one-to-one function`,formula:String.raw`f(x)=2x+1`,inputs:[1,2,3,4],outputs:[3,5,7,9],arrows:[[0,0],[1,1],[2,2],[3,3]],verdict:`Function and one-to-one`,copy:`Every input has one arrow, and every used output receives one arrow.`,tone:`good`},collision:{name:`A function with collisions`,formula:String.raw`f(x)=x^2`,inputs:[-2,-1,1,2],outputs:[1,4],arrows:[[0,1],[1,0],[2,0],[3,1]],verdict:`Function, but not one-to-one`,copy:`Each input has one output, but opposite inputs collide at the same output.`,tone:`warn`},split:{name:`A relation with a split input`,formula:String.raw`x=2\longmapsto 4\text{ and }7`,inputs:[1,2,3],outputs:[2,4,7],arrows:[[0,0],[1,1],[1,2],[2,1]],verdict:`Not a function`,copy:`Input 2 has two arrows. It fails before one-to-one behavior can even be tested.`,tone:`bad`}};function S(e,t){return t===1?195:92+e/(t-1)*206}function C(t){let n=x[t];document.querySelectorAll(`[data-mapping]`).forEach(e=>{let n=e.dataset.mapping===t;e.classList.toggle(`is-active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelector(`#mapping-name`).textContent=n.name,e(document.querySelector(`#mapping-formula`),n.formula),document.querySelector(`#mapping-copy`).textContent=n.copy;let r=n.inputs.map((e,t)=>`<g class="mapping-node mapping-node--input"><circle cx="130" cy="${S(t,n.inputs.length)}" r="25"/><text x="130" y="${S(t,n.inputs.length)+6}">${b(e)}</text></g>`).join(``),i=n.outputs.map((e,t)=>`<g class="mapping-node mapping-node--output"><circle cx="530" cy="${S(t,n.outputs.length)}" r="25"/><text x="530" y="${S(t,n.outputs.length)+6}">${b(e)}</text></g>`).join(``),a=n.arrows.reduce((e,[,t])=>(e[t]=(e[t]||0)+1,e),{}),o=n.arrows.map(([e,t])=>{let r=S(e,n.inputs.length),i=S(t,n.outputs.length);return`<path d="M156 ${r}C270 ${r} 390 ${i} 504 ${i}" class="mapping-arrow${a[t]>1?` is-collision`:``}"/>`}).join(``);document.querySelector(`#mapping-chart`).innerHTML=`
  ...
  `,e(document.querySelector(`#horizontal-equation`),t.formula),document.querySelector(`#horizontal-y-output`).textContent=b(n,1);let s=o.length,c=document.querySelector(`#horizontal-result`);c.className=`horizontal-result ${s>1?`is-collision`:`is-clear`}`,c.innerHTML=`<span>${s} intersection${s===1?``:`s`} at this height</span><strong>${t.verdict}</strong><p>${t.explanation}</p>`}document.querySelectorAll(`[data-horizontal]`).forEach(e=>{e.addEventListener(`click`,()=>{k=e.dataset.horizontal;let t=O[k];A.min=t.scanMin,A.max=t.scanMax,A.step=`0.1`,A.value=t.initial,document.querySelectorAll(`[data-horizontal]`).forEach(t=>{let n=t===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-selected`,String(n))}),j()})}),A.addEventListener(`input`,j),j();var M=[[-3,-2],[-2,-.75],[2,-.5],[4,2]],N=document.querySelector(`#reflection-point`),P=!0,F=w({width:620,height:620,padding:48,xMin:-5,xMax:5,yMin:-5,yMax:5});function I(e,t){return`M${t.x(e[0][0])} ${t.y(e[0][1])}C${t.x(e[1][0])} ${t.y(e[1][1])} ${t.x(e[2][0])} ${t.y(e[2][1])} ${t.x(e[3][0])} ${t.y(e[3][1])}`}function L(e,t){let n=1-t,r=[n**3,3*n**2*t,3*n*t**2,t**3];return{x:e.reduce((e,t,n)=>e+t[0]*r[n],0),y:e.reduce((e,t,n)=>e+t[1]*r[n],0)}}function R(){let t=Number(N.value)/100,n=L(M,t),r=M.map(([e,t])=>[t,e]);document.querySelector(`#reflection-chart`).innerHTML=`
    ...
    <circle cx="${F.x(n.x)}" cy="${F.y(n.y)}" r="10" class="reflection-point reflection-point--forward"/>
    <circle cx="${F.x(n.y)}" cy="${F.y(n.x)}" r="10" class="reflection-point reflection-point--inverse${P?` is-visible`:``}"/>
    <line x1="${F.x(n.x)}" y1="${F.y(n.y)}" x2="${F.x(n.y)}" y2="${F.y(n.x)}" class="reflection-connector${P?` is-visible`:``}"/>
  `,document.querySelector(`#reflection-point-output`).textContent=`${Math.round(t*100)}%`,e(document.querySelector(`#reflection-forward-point`),String.raw`(${b(n.x)},${b(n.y)})`),e(document.querySelector(`#reflection-inverse-point`),String.raw`(${b(n.y)},${b(n.x)})`)}document.querySelector(`#reflection-toggle`).addEventListener(`click`,e=>{P=!P,e.currentTarget.setAttribute(`aria-pressed`,String(P)),e.currentTarget.textContent=P?`Hide inverse graph`:`Show inverse graph`,R()}),N.addEventListener(`input`,R),R();var z=document.querySelector(`#undo-x`);function B(){let e=Number(z.value),r=e**5+e**3+e,a=i(r,3,.001);document.querySelector(`#undo-x-output`).textContent=b(e,1),document.querySelector(`#undo-input-value`).textContent=b(e,1),document.querySelector(`#undo-output-value`).textContent=b(r,2),document.querySelector(`#undo-reverse-input`).textContent=b(r,2),document.querySelector(`#undo-reverse-output`).textContent=b(e,1);let o=document.querySelector(`#undo-target-meter`);o.style.width=`${Math.max(3,100-Math.min(100,Math.abs(r-3)*18))}%`;let s=document.querySelector(`#undo-verdict`);s.className=`undo-verdict ${a?`is-correct`:``}`,s.innerHTML=a?`<strong>Target found.</strong>${n(String.raw`f(1)=3\Longrightarrow f^{-1}(3)=1`)}`:`<strong>Keep searching.</strong><span>The current output is ${b(r,2)}; move it toward 3.</span>`,t(s)}z.addEventListener(`input`,B),B();var V={linear:{formula:String.raw`f(x)=3x-5`,note:`A nonhorizontal linear function is one-to-one on all real numbers.`,steps:[{label:`Write with y`,math:String.raw`y=3x-5`},{label:`Switch x and y`,math:String.raw`x=3y-5`},{label:`Solve for y`,math:String.raw`y=\frac{x+5}{3}`},{label:`Name the inverse`,math:String.raw`f^{-1}(x)=\frac{x+5}{3}`}],check:String.raw`f\!\left(f^{-1}(x)\right)=3\left(\frac{x+5}{3}\right)-5=x`},cube:{formula:String.raw`f(x)=(x-2)^3+1`,note:`A shifted cubic remains one-to-one because it rises through its entire domain.`,steps:[{label:`Write with y`,math:String.raw`y=(x-2)^3+1`},{label:`Switch x and y`,math:String.raw`x=(y-2)^3+1`},{label:`Undo cube, then shift`,math:String.raw`\sqrt[3]{x-1}=y-2`},{label:`Name the inverse`,math:String.raw`f^{-1}(x)=\sqrt[3]{x-1}+2`}],check:String.raw`f^{-1}(f(x))=\sqrt[3]{(x-2)^3}+2=x`},rational:{formula:String.raw`f(x)=\frac{2x+3}{x-4}`,note:`Track excluded values: the original omits x = 4, while the inverse omits x = 2.`,steps:[{label:`Write with y`,math:String.raw`y=\frac{2x+3}{x-4}`},{label:`Switch x and y`,math:String.raw`x=\frac{2y+3}{y-4}`},{label:`Collect the y terms`,math:String.raw`xy-4x=2y+3\Longrightarrow y(x-2)=4x+3`},{label:`Name the inverse`,math:String.raw`f^{-1}(x)=\frac{4x+3}{x-2},\quad x\ne2`}],check:String.raw`D_{f^{-1}}=R_f=(-\infty,2)\cup(2,\infty)`}},H=`linear`,U=1;function W(){let r=V[H];e(document.querySelector(`#inverse-step-function`),r.formula),document.querySelector(`#inverse-step-note`).textContent=r.note,document.querySelector(`#inverse-steps`).innerHTML=r.steps.map((e,t)=>`
    <li class="${t<U?`is-visible`:``}">
      <span>${t+1}</span>
      <div><small>${t<U?e.label:`Hidden step`}</small><strong>${t<U?n(e.math):`?`}</strong></div>
    </li>
  `).join(``),t(document.querySelector(`#inverse-steps`));let i=U===r.steps.length,a=document.querySelector(`#inverse-step-next`);a.disabled=i,a.textContent=i?`Inverse complete`:`Reveal next step`;let o=document.querySelector(`#inverse-step-check`);i?e(o,r.check):o.textContent=`Complete the reversal to reveal a verification.`}document.querySelectorAll(`[data-inverse-case]`).forEach(e=>{e.addEventListener(`click`,()=>{H=e.dataset.inverseCase,U=1,document.querySelectorAll(`[data-inverse-case]`).forEach(t=>{let n=t===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-selected`,String(n))}),W()})}),document.querySelector(`#inverse-step-next`).addEventListener(`click`,()=>{U=Math.min(V[H].steps.length,U+1),W()}),document.querySelector(`#inverse-step-reset`).addEventListener(`click`,()=>{U=1,W()}),W(),document.querySelector(`#check-one-to-one`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-quartic-full`).value===`correct`&&document.querySelector(`#check-quartic-restricted`).value===`correct`;l(document.querySelector(`#feedback-one-to-one`),e,e?`Correct. The unrestricted quartic repeats heights, while restricting to ${n(String.raw`0\le x\le2`)} keeps only its increasing side.`:`Use the horizontal-line test. The full quartic has two symmetric sides; the restricted graph has only the right side.`)}),document.querySelector(`#check-inverse-values`).addEventListener(`click`,()=>{let e=Number(document.querySelector(`#check-inverse-value`).value)===4&&document.querySelector(`#check-inverse-composition`).value===`correct`;l(document.querySelector(`#feedback-inverse-values`),e,e?`Correct. ${n(String.raw`f(4)=17`)} reverses to ${n(String.raw`f^{-1}(17)=4`)}, and inverse composition returns its input.`:`Reverse the known input-output pair. A function composed with its inverse returns the entire starting expression.`)}),document.querySelector(`#check-inverse-point`).addEventListener(`click`,()=>{let e=Number(document.querySelector(`#check-inverse-point-x`).value)===-3&&Number(document.querySelector(`#check-inverse-point-y`).value)===2;l(document.querySelector(`#feedback-inverse-point`),e,e?`Correct. Reflection across ${n(String.raw`y=x`)} switches ${n(String.raw`(2,-3)`)} to ${n(String.raw`(-3,2)`)}`:`Switch the coordinate positions: the old y-value becomes the new x-value.`)}),document.querySelector(`#check-inverse-rule-button`).addEventListener(`click`,()=>{let e=document.querySelector(`#check-inverse-rule`).value===`correct`;l(document.querySelector(`#feedback-inverse-rule`),e,e?`Correct. Switching variables in ${n(String.raw`y=3x-5`)} and solving gives ${n(String.raw`f^{-1}(x)=\frac{x+5}{3}`)}.`:`Switch x and y, then undo subtraction by adding 5 before dividing by 3.`)}),o();
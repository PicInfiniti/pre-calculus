  ...
  <main>
      ...
      <div class="graph-reader" data-reveal>
        ...
        <div class="graph-reader__copy">
          ...
          <div class="reader-branches">
            <button type="button" class="is-active" data-reader-branch="one"><strong>${n(String.raw`-2`)}</strong><span>${n(String.raw`-3\le x\le-1`)}</span></button>
            <button type="button" data-reader-branch="two"><strong>${n(String.raw`2x+2`)}</strong><span>${n(String.raw`-1<x\le0`)}</span></button>
            <button type="button" data-reader-branch="three"><strong>${n(String.raw`\frac{x}{2}+2`)}</strong><span>${n(String.raw`0<x\le2`)}</span></button>
          </div>
          <div class="reader-facts">
            <article><span>Domain</span><strong>${n(String.raw`[-3,2]`)}</strong></article>
            <article><span>Range</span><strong>${n(String.raw`\{-2\}\cup(0,3]`)}</strong></article>
          </div>
          <div class="reader-net-change">
            <span>Net change from ${n(String.raw`x=0`)} to ${n(String.raw`x=2`)}</span>
            <strong>${n(String.raw`f(2)-f(0)=3-2=1`)}</strong>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="lesson-section lesson-section--soft" id="circle-branches">
      <div class="lesson-section__intro" data-reveal>
        ...
        <p>Solving ${n(String.raw`x^2+y^2=36`)} for ${n(String.raw`y`)} gives two signs. Geometry chooses the sign; the requested left or right side restricts the domain.</p>
      </div>
      ...
      <div class="circle-branch-lab" data-reveal>
        ...
        <div class="circle-branch-lab__controls">
          ...
          <ol>
            <li><span>1</span><p>Isolate ${n(String.raw`y^2`)}: ${n(String.raw`y^2=36-x^2`)}.</p></li>
            <li><span>2</span><p>Take both branches: ${n(String.raw`y=\pm\sqrt{36-x^2}`)}.</p></li>
      ...
      <div class="reconstruction-studio" data-reveal>
        ...
        <section data-reconstruction-panel="a">
          ...
          <div class="reconstruction-copy">
            ...
            <h3>${n(String.raw`p(x)=`)}</h3>
            <div class="reconstruction-rules">
              <span><strong>${n(String.raw`-2`)}</strong><i>if ${n(String.raw`-7\le x\le-4`)}</i></span>
              <span><strong>${n(String.raw`\sqrt{16-x^2}`)}</strong><i>if ${n(String.raw`-4<x\le4`)}</i></span>
              <span><strong>${n(String.raw`1-\frac{x}{2}`)}</strong><i>if ${n(String.raw`x>4`)}</i></span>
            </div>
        ...
        <section data-reconstruction-panel="b" hidden>
          ...
          <div class="reconstruction-copy">
            ...
            <h3>${n(String.raw`g(x)=`)}</h3>
            <div class="reconstruction-rules">
              <span><strong>${n(String.raw`3`)}</strong><i>if ${n(String.raw`-5<x<-2`)}</i></span>
              <span><strong>${n(String.raw`\frac{3x}{2}-1`)}</strong><i>if ${n(String.raw`-2\le x<4`)}</i></span>
              <span><strong>${n(String.raw`-5`)}</strong><i>if ${n(String.raw`4<x\le8`)}</i></span>
            </div>

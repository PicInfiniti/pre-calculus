import"./magnifier-B0Wyiml3.js";import{a as e,i as t,o as n,r,s as i}from"./shared-DVcn0svv.js";var a=document.querySelector(`#app`),o=(e,t=!1)=>`<span class="native-math${t?` native-math--display`:``}">${e}</span>`,s=(e,t)=>`<span class="native-frac"><span>${e}</span><span>${t}</span></span>`;a.innerHTML=`
  ${n(`3.6`)}
  <main>

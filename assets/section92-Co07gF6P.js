import"./magnifier-B0Wyiml3.js";import{r as e,t}from"./math-BBrN9Pw_.js";import{a as n,i as r,n as i,o as a,r as o,s}from"./shared-Cg4hcz2F.js";var c=document.querySelector(`#app`);c.innerHTML=`
  ${a(`9.2`)}
  <main>
    <section class="lesson-hero lesson-hero--blue">
      ...
      <div class="plane-hero-art" aria-hidden="true" data-reveal>
        ...
        <div class="plane-art__equation">${t(String.raw`ax+by+cz=d`)}</div>
      </div>
    </section>
      ...
      <div class="funnel" data-reveal>
        <div class="funnel__stage funnel__stage--three">
          ...
          <div class="numbered-system">
            <p><i class="eq-number">1</i> ${t(String.raw`3x+2y-z=-7`)}</p>
            <p><i class="eq-number">2</i> ${t(String.raw`6x-y+3z=-4`)}</p>
            <p><i class="eq-number">3</i> ${t(String.raw`x+10y-2z=2`)}</p>
          </div>
        </div>
        ...
        <div class="funnel__stage funnel__stage--two">
          ...
          <div class="numbered-system">
            <p>${t(String.raw`3(1)+(2)\longrightarrow 15x+5y=-25`)}</p>
            <p>${t(String.raw`2(1)-(3)\longrightarrow 5x-6y=-16`)}</p>
          </div>
        </div>
        <div class="funnel__arrow"><span>Simplify and solve</span>↓</div>
        <div class="funnel__stage funnel__stage--one">
          <span>Shared point</span>
          <strong>${t(String.raw`(x,y,z)=(-2,1,3)`)}</strong>
      ...
      <div class="elimination-studio" data-reveal>
        <div class="studio-source">
          ...
          <div class="numbered-system numbered-system--large">
            <p><i class="eq-number">1</i> ${t(String.raw`3x-2y+9z=2`)}</p>
            <p><i class="eq-number">2</i> ${t(String.raw`-2x-5y-4z=3`)}</p>
            <p><i class="eq-number">3</i> ${t(String.raw`5x-3y+3z=15`)}</p>
          </div>
    ...
    <section class="lesson-section lesson-section--soft" id="triangular-form">
      ...
      <div class="triangle-lab" data-reveal>
        <div class="triangle-system" aria-label="Triangular system">
          <div><span>${t(String.raw`2x-y+6z=5`)}</span><i>three variables</i></div>
          <div><span>${t(String.raw`y+4z=0`)}</span><i>two variables</i></div>
          <div><span>${t(String.raw`-2z=1`)}</span><i>one variable</i></div>
        </div>
    ...
    <section class="lesson-section" id="special-cases">
      ...
      <div class="zero-row-grid" data-reveal>
        <article class="zero-card zero-card--free"><span>${t(String.raw`0=0`)}</span><h3>True for every value</h3><p>The row was redundant. At least one variable may be free, producing infinitely many solutions.</p></article>
        <article class="zero-card zero-card--stop"><span>${t(String.raw`0=7`)}</span><h3>Never true</h3><p>The equations contradict one another. The system has no solution.</p></article>
      </div>
      ...
      <div class="parameter-line" data-reveal>
        <div class="parameter-line__copy">
          ...
          <div class="numbered-system numbered-system--large">
            <p>${t(String.raw`5x+y-2z=10`)}</p>
            <p>${t(String.raw`y+3z=5`)}</p>
            <p>${t(String.raw`0=0`)}</p>
          </div>
        ...
        <div class="parameter-line__visual">
          <span>Let ${t(String.raw`z=t`)}</span>
          ...
          <div class="verification"><p>${t(String.raw`5x+y-2z=`)} <strong id="verify-one">10</strong></p><p>${t(String.raw`y+3z=`)} <strong id="verify-two">5</strong></p></div>
          <p>Every ${t(String.raw`t`)} creates another solution: <strong>${t(String.raw`(x,y,z)=(1+t,5-3t,t)`)}</strong>.</p>
        </div>
      </div>
    </section>
